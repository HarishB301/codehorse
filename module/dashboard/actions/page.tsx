...
import {ExternalLink,Star,Search, Car} from 'lucide-react'
import {useState,useEffect,useRef} from 'react'
import { useRepositories } from '@/module/repository/hooks/user-repository'
                    ...
                    <div className='flex gap-2'>
                       <Button variant='ghost' size='icon' asChild>
                        ...
                        variant={repo.isConnected ? "outline":'default'}>
                          {localConnectingId === repo.id ? "Connecting...": repo.isConnected ? "Connected" : ''}
                        </Button>
