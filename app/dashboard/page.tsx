...
import ContributionGraph from '@/module/dashboard/actions/contribution-graph'
      ...
      <div className="">
        <Card>
          <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
            ...
            <GitBranch className='h-4 w-4 text-muted-foreground'></GitBranch>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{isLoading ? "...":(stats?.totalCommits || 0).toLocalString()}</div>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className='text-xs text-muted-foreground'>connected reviews</p>
          </CardContent>
        </Card>
      </div>
